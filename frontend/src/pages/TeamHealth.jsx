        ...
        <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.15 }} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="rounded-2xl p-6 relative overflow-hidden group border border-white/10" style={{ background: 'rgba(255,255,255,0.05)' }}>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-sm text-text-muted font-medium">Total AI Tokens</span>
            </div>
            <div className="text-4xl font-bold text-indigo-400">
              <AnimatedCounter value={stats.tokenUsage.totalGrand} />
            </div>
            <p className="text-xs text-text-muted mt-2">{(stats.today.tokens || 0).toLocaleString()} consumed today</p>
          </div>
          ...
          <div className="rounded-2xl p-6 relative overflow-hidden group border border-white/10" style={{ background: 'rgba(255,255,255,0.05)' }}>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-sm text-text-muted font-medium">Infrastructure Cost</span>
            </div>
            <div className="text-4xl font-bold text-emerald-400">
              {stats.tokenUsage.totalCost}
            </div>
            <p className="text-xs text-text-muted mt-2">{stats.today.cost || '$0.0000'} spent today</p>
          </div>

          {/* Input Tokens */}
          <div className="rounded-2xl p-6 relative overflow-hidden group border border-white/10" style={{ background: 'rgba(255,255,255,0.05)' }}>
             <div className="flex items-center gap-3 mb-3 text-text-muted text-sm font-medium">
               Input Tokens
             </div>
